...
// Date: 7/5/2026
// Description: This file blinks an LED by setting a GPIO pin directly using registers (both enabling it as an output and setting and clearing it's output register) using part 1) the Arduino delay() macro
// and part 2) timers configured directly via register access.
...
void setup() {
  // Pin setup for both part 1 and part 2.
  ...
  *((volatile uint32_t*) GPIO_ENABLE_REG) |= GPIO_PIN_5_MASK; // Enable the GPIO pin as an output.
  ...
  // Timer configuration specific to part 2.
